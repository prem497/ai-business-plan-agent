"""
AI Business Plan Agent — Streamlit Frontend
ai business plan agent (NLP, LangChain, SQLite, FastAPI, etc)
"""
...
# ─────────────────────────────────────────────
st.set_page_config(
    page_title="AI Business Plan Agent",
    page_icon="✨",
    layout="wide",
...
def generate_report_text(plan: dict) -> str:
    ...
    lines.append("=" * 70)
    lines.append(f"  AI BUSINESS PLAN AGENT — FULL BUSINESS PLAN REPORT")
    ...
    lines.append("")
    lines.append("=" * 70)
    lines.append("  Generated by AI Business Plan Agent")
    lines.append("=" * 70)
...
with st.sidebar:
    ...
    <div style="display:flex;align-items:center;gap:10px;padding:0.5rem 0 1.2rem;">
        ...
        <div>
            <div style="font-family:Outfit,sans-serif;font-weight:700;font-size:1.05rem;color:white;">AI Business Plan</div>
...
if st.session_state.page == "new_plan":
    ...
    <div class="biz-header">
        <div class="biz-logo">✨ <span>AI Business Plan Agent</span></div>
        <div class="biz-title">
            <h1>ai business plan agent</h1>
            <p>Powered by NLP, LangChain, SQLite, Streamlit & FastAPI</p>
        </div>
    ...
    with left_col:
        ...
        if st.session_state.generated and st.session_state.plan_data:
            ...
            fname = f"{company_for_dl.replace(' ', '_')}_Report.txt"
            st.download_button(
...
# ─────────────────────────────────────────────
    ...
    page_map = {
        ...
        "reports":         ("📈", "Reports",           "Generate detailed analytical reports and PDF exports of your data."),
        "ai_chat":         ("🤖", "AI Chat Assistant", "Chat with AI Business Plan Agent for business advice and strategy."),
    }
